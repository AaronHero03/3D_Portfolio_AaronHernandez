...
export const myProjects = [
	{
		...
		logoStyle: {
			...
			background:
				"linear-gradient(0deg, #2A1816, #47211d), linear-gradient(180deg, rgba(255, 255, 255, 0.9) 0%, rgba(208, 213, 221, 0.8) 100%)",
	...
	},
	{
		...
		logoStyle: {
			...
			background:
				"linear-gradient(0deg, #13202F, #22485e), linear-gradient(180deg, rgba(255, 255, 255, 0.9) 0%, rgba(208, 213, 221, 0.8) 100%)",
	...
	},
	{
		...
		logoStyle: {
			backgroundColor: "#0a403b",
			background:
				"linear-gradient(0deg, #0a403b, #11734f), linear-gradient(180deg, rgba(255, 255, 255, 0.9) 0%, rgba(208, 213, 221, 0.8) 100%)",
			border: "0.2px solid rgba(101, 235, 199, 0.1)",
	...
	},
	{
		...
		logoStyle: {
			...
			background:
				"linear-gradient(0deg, #0E1F38, #173561), linear-gradient(180deg, rgba(255, 255, 255, 0.9) 0%, rgba(208, 213, 221, 0.8) 100%)",
	...
	},
	{
		...
		logoStyle: {
			...
			background:
				"linear-gradient(0deg, #1C1A43, #27245c), linear-gradient(180deg, rgba(255, 255, 255, 0.9) 0%, rgba(208, 213, 221, 0.8) 100%)",
...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
	return {
		deskScale: isSmall ? 0.05 : isMobile ? 0.055 : 0.0575,
